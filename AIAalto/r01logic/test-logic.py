...
if satisfiable(chainAND([A,OR(B,C),IMPL(B,NOT(A)),IMPL(C,NOT(A))])) != False:
  print("Test 3 FAILS")
  print(satisfiable(chainAND([A,OR(B,C),IMPL(B,NOT(A)),IMPL(C,NOT(A))])))
else:
  print("Test 3 OK")
...
if satisfiable(NOT(OR(OR(A, B), C))) == False:
  print("no esta bien implementado el satisfiable")

else: 
  print(satisfiable(NOT(OR(OR(A, B), C))))
  print("esta bien implementado el satisfiable")